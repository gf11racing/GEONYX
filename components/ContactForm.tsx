  ...
  return (
    <section id="contact" className="relative py-20 lg:py-24 xl:py-32 overflow-hidden min-h-[700px] flex items-center">
      ...
      <div className="w-full px-6 md:px-10 lg:px-20 relative z-10">
        {/* REFACTORED CONTAINER: Centered content cluster, constrained width, fixed gap */}
        <div className="flex flex-col lg:flex-row justify-center items-start gap-12 lg:gap-20 max-w-[1300px] mx-auto w-full">
          ...
          <div className="w-full lg:flex-1 max-w-2xl flex flex-col justify-center text-white pt-10 lg:pt-0">
            ...
            {/* Standardized Micro-Label (Horizontal Line) */}
            <div className="flex items-center justify-start gap-3 mb-6">
                <div className="h-[2px] w-12 bg-geo-yellow shadow-[0_0_15px_#FFCC00]"></div>
                <span className="text-geo-yellow font-bold uppercase tracking-[0.3em] text-xs md:text-sm">
                    ИНЖЕНЕРНА ЕКСПЕРТИЗА
                </span>
            </div>
            
            {/* Standardized H2 Size (3xl/4xl) with Yellow Accent - STRICTLY LIMITED SIZE */}
            ...
            <p className="text-gray-300 text-base md:text-lg xl:text-xl leading-relaxed mb-8 xl:mb-12 font-light">
              Нашият инженерен екип е готов да извърши детайлен анализ на вашите съоръжения, натоварвания и химическа агресия. 
              Свържете се с нас за експертна оценка.
            </p>

            <div className="border-t border-gray-700 pt-6 xl:pt-10">
              <h4 className="text-gray-400 font-bold uppercase text-xs xl:text-sm tracking-wider mb-4 xl:mb-6">КАКВО ПОЛУЧАВАТЕ:</h4>
              <ul className="space-y-3 xl:space-y-5 text-sm md:text-base xl:text-lg text-gray-200">
                <li className="flex items-center gap-3">
                  ...
                  Техническа спецификация и анализ на риска
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-geo-yellow flex-shrink-0"></span>
                  Гаранция за качество и HSEQ съответствие
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-geo-yellow flex-shrink-0"></span>
                  Пълна проектна документация (TDS/SDS)
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="bg-[#141414] border border-[#333] w-full p-8 md:p-10 xl:p-16 shadow-2xl rounded-sm">
               {formState === 'success' ? (
                  <div className="h-full flex flex-col justify-center items-center text-center py-20">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-4">Запитването е изпратено!</h3>
                    <p className="text-gray-400 mb-8 text-base">Благодарим ви за интереса. Ще се свържем с вас скоро.</p>
                    <button 
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8 xl:space-y-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8 xl:gap-y-10">
                      {/* Name */}
                      <div className="group">
                        <label htmlFor="name" className="block text-[10px] md:text-xs xl:text-sm font-bold text-gray-500 uppercase tracking-wide mb-2">ИМЕ*</label>
                        <input 
                          type="text" 
                          id="name"
                          name="name"
                      ...
                      {/* Company */}
                      <div className="group">
                        <label htmlFor="company" className="block text-[10px] md:text-xs xl:text-sm font-bold text-gray-500 uppercase tracking-wide mb-2">ФИРМА*</label>
                        <input 
                          type="text" 
                          id="company"
                          name="company"
                      ...
                      {/* Email */}
                      <div className="group">
                        <label htmlFor="email" className="block text-[10px] md:text-xs xl:text-sm font-bold text-gray-500 uppercase tracking-wide mb-2">ИМЕЙЛ*</label>
                        <input 
                          type="email" 
                          id="email"
                          name="email"
                      ...
                      {/* Phone */}
                      <div className="group">
                        <label htmlFor="phone" className="block text-[10px] md:text-xs xl:text-sm font-bold text-gray-500 uppercase tracking-wide mb-2">ТЕЛЕФОН*</label>
                        <input 
                          type="tel" 
                          id="phone"
                          name="phone"
                    ...
                    {/* Industry Select */}
                    <div className="group">
                        <label htmlFor="sector" className="block text-[10px] md:text-xs xl:text-sm font-bold text-geo-yellow uppercase tracking-wide mb-2">ТИП ИНДУСТРИЯ*</label>
                        <div className="relative">
                            ...
                            >
                                <option value="" disabled className="bg-[#141414]">-- Изберете Сектор --</option>
                                <option value="heavy" className="bg-[#141414]">Тежка Индустрия & Логистика</option>
                                <option value="food" className="bg-[#141414]">Хранително-вкусова & Фармация</option>
                                <option value="agro" className="bg-[#141414]">Агро, Биогаз & Животински среди</option>
                                <option value="water" className="bg-[#141414]">Водна & Морска Инфраструктура</option>
                                <option value="energy" className="bg-[#141414]">Енергетика, Мини & Тежка защита</option>
                                <option value="transport" className="bg-[#141414]">Транспорт, Паркинги & Гаражи</option>
                                <option value="urban" className="bg-[#141414]">Градска среда & Строителство</option>
                                <option value="other" className="bg-[#141414]">Друго</option>
                            </select>
                    ...
                    {/* Details */}
                    <div className="group">
                        <label htmlFor="details" className="block text-[10px] md:text-xs xl:text-sm font-bold text-gray-500 uppercase tracking-wide mb-2">ДЕТАЙЛИ ЗА ПРОЕКТА</label>
                        <textarea 
                          id="details"
                          name="details"
                          rows={1}
                          ...
                          placeholder="Квадратура, тип на обекта..." 
                          onInput={(e) => {
                    ...
                    <div className="pt-4">
                         ...
                         >
                             {formState === 'submitting' ? 'ИЗПРАЩАНЕ...' : 'ЗАЯВИ ИНЖЕНЕРЕН ОДИТ'}
                         </Button>
                         <p className="mt-4 text-[10px] xl:text-xs text-gray-500 text-center">
                             С изпращането на формата се съгласявате с <a href="/privacy-policy" className="underline hover:text-white">Политиката за поверителност</a>.
                         </p>
                    </div>
                  </form>
               )}
