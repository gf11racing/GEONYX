      ...
      <div className="relative z-10 container mx-auto px-6 text-left flex-1 flex flex-col justify-center py-20 md:py-32">
        <div className="max-w-5xl">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1] mb-6 uppercase tracking-tighter drop-shadow-2xl page-animate-title">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-geo-yellow to-yellow-600">{t('hero.titleLine3')}</span>
          </h1>
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-12 font-light max-w-4xl leading-relaxed border-l-4 border-geo-yellow pl-4 md:pl-6 py-2 bg-black/30 backdrop-blur-sm page-animate-desc">
            {t('hero.description')}
            <span className="text-white font-bold block mt-1">{t('hero.descriptionBold')}</span>
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 page-animate-buttons">
            <Button
              ...
              onClick={() => navigate(to('/sectors'))}
            >
              {t('hero.btnSectors')} <ArrowRight className="w-4 h-4" />
            </Button>
            ...
            <button
              ...
              onClick={() => navigate(to('/technical-maps'))}
            >
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex flex-wrap justify-start items-center gap-x-6 md:gap-x-12 gap-y-4">
            ...
            <div className="flex items-center gap-3 group cursor-default">
               <span className="text-gray-500 font-bold uppercase text-[10px] tracking-widest">{t('hero.statChemistry')}</span>
            ...
            <div className="flex items-center gap-3 group cursor-default">
               <span className="text-gray-500 font-bold uppercase text-[10px] tracking-widest">{t('hero.statStrength')}</span>
            ...
            <div className="flex items-center gap-3 group cursor-default">
               <span className="text-gray-500 font-bold uppercase text-[10px] tracking-widest">{t('hero.statFire')}</span>
               <span className="text-geo-yellow font-mono font-bold text-sm tracking-tight">{t('hero.fireClass')}</span>
            </div>

            <div className="w-[1px] h-4 bg-white/10 hidden sm:block"></div>

            <div className="flex items-center gap-3 group cursor-default">
               <span className="text-gray-500 font-bold uppercase text-[10px] tracking-widest">{t('hero.statEco')}</span>
