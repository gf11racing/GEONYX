...
export const WaterMarinePage: React.FC = () => {
  usePageMeta('watermarine');
  const navigate = useNavigate();
  const { t } = useTranslation('watermarine');
  const { to } = useLang();
                  ...
                  <table className="w-full min-w-[900px] border-collapse text-left">
                      <thead>
                          <tr className="bg-black">
                              ...
                              <th className="p-4 text-gray-500 font-bold uppercase tracking-wider text-xs border-b border-[#333] w-1/4">{t('roi.colPolymer')}</th>
                          </tr>
                      </thead>
                      <tbody className="divide-y divide-[#333] text-sm">
                          <tr>
                              ...
                              <td className="p-4 text-gray-500">{t('roi.r1polymer')}</td>
                          </tr>
                          <tr>
                              ...
                              <td className="p-4 text-gray-500">{t('roi.r2polymer')}</td>
                          </tr>
                          <tr>
                              ...
                              <td className="p-4 text-gray-500">{t('roi.r3polymer')}</td>
                          </tr>
                          <tr>
                              ...
                              <td className="p-4 text-gray-500">{t('roi.r4polymer')}</td>
                          </tr>
                          <tr>
                              ...
                              <td className="p-4 text-gray-500">{t('roi.r5polymer')}</td>
                          </tr>
                      </tbody>
                  </table>
              </div>
