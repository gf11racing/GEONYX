    ...
    <div className="min-h-screen bg-[#0b0c10] font-sans text-gray-200 overflow-x-hidden selection:bg-geo-yellow selection:text-black">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="grid grid-cols-2 gap-x-4 text-gray-300 text-xs font-bold uppercase leading-tight">
                                <div className="flex flex-col gap-3">
                                    <span className="border-l-2 border-geo-yellow pl-2">Скейт паркове и велоалеи</span>
                                    <span className="border-l-2 border-geo-yellow pl-2">Градска мебел – пейки, кашпи</span>
                                    <span className="border-l-2 border-geo-yellow pl-2">Фугиране на павета и плочници</span>
                                    <span className="border-l-2 border-geo-yellow pl-2">Пешеходни площи и входове</span>
                                    <span className="border-l-2 border-geo-yellow pl-2">Подлези и подземни проходи</span>
                                </div>
                                <div className="flex flex-col gap-3">
                                    <span className="border-l-2 border-geo-yellow pl-2">Метростанции и спирки</span>
                                    <span className="border-l-2 border-geo-yellow pl-2">Обществени сгради</span>
                                    <span className="border-l-2 border-geo-yellow pl-2">Авиационни хангари и MRO</span>
                                    <span className="border-l-2 border-geo-yellow pl-2">Clean rooms и ESD зони</span>
                                    <span className="border-l-2 border-geo-yellow pl-2">Data centers и R&D центрове</span>
                                </div>
                            </div>
                        </div>
      ...
      <div className="w-full bg-[#0b0c10]">
        ...
        <section className="flex flex-col lg:flex-row-reverse w-full min-h-[600px] border-b border-[#222]">
            <div className="w-full lg:w-1/2 relative min-h-[400px] bg-black group overflow-hidden">
                <SafeImage 
                    src="/GEONYX-AUTOMOTIVE-AND-EV.webp" 
